...
def questions(request):
    ...
    # Get questions list
    question_list = Question.objects.filter(patient=request.user, gasgoal=selected_goal, activated = 1)
